...
OutputBaseFilename=JcsPhotoGallery_App_1.1.1_setup_x64.exe
...
[Run]
Filename: "{app}\jre-7u5-windows-x64"; Parameters: ""; Check: IsJREInstalled; Flags: runhidden shellexec waituntilterminated
