/*	
 * 	File    : JcsPhotoGalleryDesktopView.java
 * 
 * 	Copyright (C) 2012-2014 Daniel Cioi <dan@dancioi.net>
 *                              
...
/**
 * JcsPhotoGallery's view for desktop browsers.
 * 
 * @author Daniel Cioi <dan@dancioi.net>
 * @version $Revision$ Last modified: $Date: 2013-09-08 22:50:02 +0200
 *          (Sun, 08 Sep 2013) $, by: $Author$
 */
public class JcsPhotoGalleryDesktopView extends JcsPhotoGalleryView {
	...
	public void showPopUpImg(int id, String imgPath, PictureBean[] pictures) {
		new PopUpImgShowDesktop(id - 1, imgPath, pictures).show();
	}
