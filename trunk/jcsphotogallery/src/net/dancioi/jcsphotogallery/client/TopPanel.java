...
public class TopPanel extends AbsolutePanel{
	...
	/**
	 * This method get the selected item from ListBox
	 * and pass it. 
	...
	/**
	 * This method add the gallery owner home link web page.
	 * the owner is read from albums.xml file.
	 * 
	 * @param name the gallery owner's name
	 * @param nameHomePage the gallery owner's link to home page. 
	 */
	 ...
	 * @param sorted a list with sorted items.
	 */
